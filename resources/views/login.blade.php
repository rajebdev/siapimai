...
@section('container')
                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                    ...
                                    <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">SIAPIMAI</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <form role="form" class="text-start">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn bg-gradient-primary w-100 my-4 mb-2" id="signinBtn">Sign
                                            in</button>
                                    </div>
        ...
        <script>
            jQuery(document).ready(function () {
                jQuery('#signinBtn').click(function (e) {
                    e.preventDefault();
                    $.ajaxSetup({
                        headers: {
